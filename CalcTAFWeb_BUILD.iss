...
[Icons]
Name: "{group}\CalcTAF Web"; Filename: "{sys}\wscript.exe"; Parameters: """{app}\scripts\iniciar-calctaf.vbs"""; WorkingDir: "{app}"; IconFilename: "{app}\app\frontend\dist\icon\CalcTAFWeb.ico"
Name: "{userdesktop}\CalcTAF Web"; Filename: "{sys}\wscript.exe"; Parameters: """{app}\scripts\iniciar-calctaf.vbs"""; WorkingDir: "{app}"; IconFilename: "{app}\app\frontend\dist\icon\CalcTAFWeb.ico"
