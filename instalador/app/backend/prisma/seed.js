...
async function main() {
  ...
  await prisma.curso.createMany({
    ...
    data: [
      {
        nome: "Linha de Ensino Militar BÃ©lico",
        codigo: "LEMB"
      },
      {
        nome: "Linha de Ensino Militar de SaÃºde",
        codigo: "LEMS"
      },
      {
      ...
      {
        nome: "Linha de Ensino Militar CientÃ­fico-TecnolÃ³gico",
        codigo: "LEMCT"
      }
    ]
  });
...
await prisma.chamadaTAF.createMany({
    ...
    data: [
      ...
      // 1Âº TAF
      {
        ...
        periodoFim: new Date("2026-03-05"),
        campanhaId: taf1.id
      },
      {
        numeroChamada: 2,
        periodoInicio: new Date("2026-03-10"),
        periodoFim: new Date("2026-03-12"),
        campanhaId: taf1.id
      },
      ...
      // 2Âº TAF
      {
        ...
        periodoFim: new Date("2026-07-05"),
        campanhaId: taf2.id
      },
      {
        numeroChamada: 2,
        periodoInicio: new Date("2026-07-10"),
        periodoFim: new Date("2026-07-12"),
        campanhaId: taf2.id
      },
      ...
      {
        numeroChamada: 1,
        periodoInicio: new Date("2026-11-01"),
        periodoFim: new Date("2026-11-05"),
        campanhaId: taf3.id
      },
      {
        numeroChamada: 2,
        periodoInicio: new Date("2026-11-10"),
        periodoFim: new Date("2026-11-12"),
        campanhaId: taf3.id
      }
    ]
});
